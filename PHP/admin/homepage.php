            ...
            <section class="secondSection" id="secondSection">
                <div class="textContainer">
                    <div class="textoGeral text">
                        ...
                        <p>
                            A <strong>Fast & Furious Cars Inc.</strong> é uma empresa de referência no mercado de aluguel de carros de luxo, oferecendo uma experiência única para clientes que buscam elegância, conforto e desempenho.
            ...
            <section class="thirdSection" id="thirdSection">
                <div class="checkthisout">
                    <div class="containerPainel">
                        <h2 class="tituloGeral title">STATS</h2>
